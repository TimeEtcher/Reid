    ...
    with h5py.File(h5_path,'r') as f:
        ...
        for i in xrange(train_num):
            ...
            model.fit_generator(Data_Generator.flow(f,flag = flag_train),
                                one_epoch,epoch_num,
                                validation_data=Data_Generator.flow(f,train_or_validation=which_val_data,flag=flag_val),nb_val_samples=nb_val_samples)
